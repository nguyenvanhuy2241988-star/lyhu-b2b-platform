...
export const NAV_ITEMS = {
    ...
    [ROLES.SALE_ADMIN]: [
        ...
        { label: "Thư viện Media", href: "/shared/media-library", icon: FolderOpen },
        { label: "Tài khoản Công ty", href: "/shared/social-accounts", icon: Globe },
        { label: "Sự kiện", href: "/events", icon: Calendar },
        { label: "Tài liệu", href: "/documents", icon: Book },
    ],
    [ROLES.ACCOUNTANT]: [
    ...
    [ROLES.ADMIN]: [
        ...
        { label: "Bản đồ Nhà Phân Phối", href: "/admin/npp-map", icon: MapPin },
        ...
        { label: "Hệ thống Affiliate", href: "/admin/affiliates", icon: UserCheck },
        { label: "Phễu tìm kiếm KOL", href: "/recruitment/affiliates/board", icon: UserPlus },
        { label: "Báo cáo Affiliate", href: "/recruitment/affiliates/reports", icon: ClipboardList },
    ...
    [ROLES.CTV]: [
        ...
        { label: "Link Affiliate", href: "/affiliate/dashboard", icon: Globe },
    ...
    [ROLES.RECRUITER]: [
        ...
        { label: "Mối quan hệ", href: "/recruitment/networking", icon: UserPlus },
        { label: "Nền tảng & Tài nguyên", href: "/recruitment/platforms", icon: Globe },
        { label: "Quản lý Affiliate (CTV/KOL)", href: "/recruitment/affiliates/board", icon: UserCheck },
        { label: "Báo cáo Affiliate", href: "/recruitment/affiliates/reports", icon: ClipboardList },
        { label: "Hồ sơ Nhân sự", href: "/hr/directory", icon: Users },
        { label: "Sự kiện", href: "/events", icon: Calendar },
        { label: "Việc cần làm", href: "/tasks", icon: ListTodo },
