                    ...
                    <div className="px-5 py-3 bg-slate-50 border-t border-slate-100">
                        <div className="flex items-start gap-2">
                            ...
                            <p className="text-xs text-slate-500 leading-relaxed">
                                {policy.penaltyNote.includes('Bonding') ? (
                                    <>
                                        {policy.penaltyNote.split('Bonding')[0]}
                                        <strong className="text-slate-700">Bonding</strong>
                                        {policy.penaltyNote.split('Bonding')[1]}
                                    </>
                                ) : policy.penaltyNote}
                            </p>
                        </div>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.5" className="w-full py-2 px-3 rounded-lg border border-slate-200 text-sm"
                                            ...
                                            onChange={(e) => setEditPolicy({ ...editPolicy, hoursPerDay: parseFloat(e.target.value) || 4.5 })}
                                        />
                                    </div>
                                </div>
                            </div>
