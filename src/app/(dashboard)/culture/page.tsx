            ...
            <div className="flex flex-col lg:flex-row gap-10 items-start">
                <div className="flex-1 space-y-6 text-slate-600 text-lg leading-relaxed w-full">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <EditableText id="intro_p3" multiline defaultText="Cuốn 'Văn hóa Doanh nghiệp LYHU' này là nơi chúng ta ghi lại những giá trị chung để nhắc nhở và định hướng mỗi ngày. Văn hóa không phải điều xa vời, mà là cách chúng ta làm việc, ứng xử, chia sẻ và gắn bó với nhau." />
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {["Sản xuất", "Nhập khẩu", "Thương mại", "Bán lẻ"].map((label, i) => (
                        <div key={i} className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center text-center">
                            <EditableImage id={`img_pillar_${i}`} className="w-16 h-16 rounded-full mb-4 !border-0 bg-white shadow-sm" label="Icon" />
