...
export default function AccountantMasterDataPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-slate-900">Danh mục MISA</h1>
                <p className="text-sm text-slate-600 mt-1">Đồng bộ mã danh mục chuẩn giữa App và phần mềm Kế toán</p>
            </div>
