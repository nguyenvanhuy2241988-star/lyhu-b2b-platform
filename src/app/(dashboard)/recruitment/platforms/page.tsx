...
import { Plus, Search, Globe, Smartphone, Users, Edit, Trash2, XCircle, Loader2, DollarSign, Lightbulb, ExternalLink } from "lucide-react";
import { getPlatforms, createPlatform, updatePlatform, deletePlatform, RecruitmentPlatform, getGroups, deleteGroup, RecruitmentGroup } from "@/lib/recruitmentStore";
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden animate-in fade-in duration-200">
                    <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1">Dữ liệu được tự động thu thập và cập nhật khi nhân viên báo cáo công việc hàng ngày.</p>
                        </div>
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="text-xs text-gray-500 uppercase bg-gray-50 border-b">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 font-semibold text-right">Cập nhật</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {groups.map((group) => (
                                    <tr key={group.id} className="bg-white hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-gray-500 max-w-[300px] truncate" title={group.notes || ''}>
                                            {group.notes || '-'}
                                        </td>
                                        <td className="px-6 py-4">
                                            <a href={group.link} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-teal-600 hover:text-teal-700 hover:underline max-w-[200px] truncate">
