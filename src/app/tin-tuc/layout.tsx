    ...
    return (
        <div className="min-h-screen bg-[#F5F5F5] flex flex-col font-sans">
            ...
            <header className="bg-white border-b border-gray-200 shadow-sm">
                ...
                <div className="max-w-[1200px] mx-auto px-4 py-6 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-6">
                    {/* Logo & Slogan */}
                    <Link href="/tin-tuc" className="flex flex-col items-center lg:items-start shrink-0 group">
                        <img 
                            src="/logo-full.png" 
                            alt="LYHU Logo" 
                            className="h-24 md:h-28 object-contain transition-transform origin-left group-hover:scale-105" 
                        />
                        <span className="mt-1 text-[10px] md:text-[11px] font-extrabold text-primary-700 uppercase tracking-[0.15em] relative">
                    ...
                    <div className="flex-1 w-full lg:w-auto flex items-center lg:justify-end gap-3 overflow-x-auto scrollbar-hide pb-2 lg:pb-1">
