                ...
                <div className="flex-1 w-full max-w-3xl mx-auto lg:mx-0">
                    ...
                    {post.thumbnail_url && (
                        <div className="w-full mb-10">
                            <div className="aspect-video w-full rounded-xl overflow-hidden bg-gray-100 shadow-sm border border-gray-100">
                                <img 
                            ...
                            <p className="text-center text-xs text-gray-500 mt-3 italic">{post.title}</p>
                        </div>
                    )}
