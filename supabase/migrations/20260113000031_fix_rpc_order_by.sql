-- Fix V2: Wrap UNION in subquery to fix ORDER BY error
-- Date: 2026-01-13
-- Previous version caused "invalid UNION/INTERSECT/EXCEPT ORDER BY clause"
...
BEGIN
    ...
    SELECT * FROM (
        ...
        AND (
            ...
            OR t.owner_id = p_user_id -- Check Owner (Fix V1)
    ...
    ORDER BY combined_results.due_date ASC;
END;
$$;
