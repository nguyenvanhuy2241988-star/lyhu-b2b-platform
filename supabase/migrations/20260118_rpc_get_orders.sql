-- RPC: Get Orders (Bypass Permissions)
-- This function runs as Security Definer (Admin) to bypass any RLS/FK issues.
-- It automatically detects the caller's role if not provided.
