-- Fix ambiguous 'id' reference in get_orders_v3
...
BEGIN
    ...
    IF p_role IS NULL THEN
        -- Alias profiles to 'prf' to avoid conflict with output 'id'
        SELECT prf.role INTO _current_role FROM public.profiles prf WHERE prf.id = _current_uid;
    ELSE
