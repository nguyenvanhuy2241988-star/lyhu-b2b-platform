...
DROP POLICY IF EXISTS "Admins can manage all kpi settings" ON public.user_kpi_settings;
...
DROP POLICY IF EXISTS "Users can view their own kpi settings" ON public.user_kpi_settings;
...
DROP FUNCTION IF EXISTS get_user_kpi_settings(UUID) CASCADE;
...
DROP FUNCTION IF EXISTS update_user_kpi_settings(UUID, INT, INT, NUMERIC, NUMERIC) CASCADE;
