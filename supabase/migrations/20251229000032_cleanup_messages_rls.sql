...
drop policy if exists "messages_insert_participant" on public.internal_messages;
...
drop policy if exists "messages_update_owner" on public.internal_messages;
...
drop policy if exists "messages_delete_owner" on public.internal_messages;
