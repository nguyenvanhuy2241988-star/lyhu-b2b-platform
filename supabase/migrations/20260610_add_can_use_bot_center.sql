-- SQL Migration: Add can_use_bot_center to profiles
-- Run this in Supabase Dashboard -> SQL Editor

ALTER TABLE public.profiles
ADD COLUMN IF NOT EXISTS can_use_bot_center BOOLEAN DEFAULT false;

-- Cập nhật RPC để trả về can_use_bot_center
