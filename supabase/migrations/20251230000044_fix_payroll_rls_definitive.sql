...
drop policy if exists "everyone_select_payroll_configs" on public.payroll_configs;
...
drop policy if exists "everyone_select_payroll_locks" on public.payroll_locks;
